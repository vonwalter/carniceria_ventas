		...
		if(isset($_POST["nuevaVenta"])){
			...
			if($respuesta == "ok"){
				if (isset($_POST["impresion"])){
					echo '<pre>'; print_r($_POST["impresion"]); echo '</pre>';
					...
					$printer -> text("CUIT: 20-23058807-5"."\n");//Nit de la empresa

					$printer -> text("Dirección: Calle Pública 44B"."\n");//Dirección de la empresa

					$printer -> text("Teléfono: +54 9 351 6694444"."\n");//Teléfono de la empresa

					$printer -> text("REMITO N.".$_POST["nuevaVenta"]."\n");//Número de factura
	...
	public function ctrDescargarReporte(){
		...
		if(isset($_GET["reporte"])){
			...
			foreach ($ventas as $row => $item){
				...
				//esto es porque algunas facturas tienen un vendedor no valido
				$vendedor = is_array($vendedor)? $vendedor["nombre"]:"Desconocido";

			 echo utf8_decode("<tr>
			 			<td style='border:1px solid #eee;'>".$item["codigo"]."</td> 
			 			<td style='border:1px solid #eee;'>".$cliente["nombre"]."</td>
			 			<td style='border:1px solid #eee;'>".$vendedor."</td>
