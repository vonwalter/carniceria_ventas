...
class ModeloVentas{
	...
	static public function mdlMostrarVentas($tabla, $item, $valor){
		...
		if($item != null){
			...
			$stmt = $link->prepare("SELECT * FROM $tabla WHERE $item = :$item ORDER BY id ASC");
			...
			$link =Conexion::conectar();
			$stmt = $link->prepare("SELECT * FROM $tabla ORDER BY id ASC");
	...
	static public function mdlRangoFechasVentas($tabla, $fechaInicial, $fechaFinal){
		...
		if($fechaInicial == null){
			...
			$link =Conexion::conectar();
			$stmt = $link->prepare("SELECT * FROM $tabla WHERE fecha like '%$fechaFinal%' ORDER BY id DESC");
			...
			if($fechaFinalMasUno == $fechaActualMasUno){
				$link =Conexion::conectar();
				$stmt = $link->prepare("SELECT * FROM $tabla WHERE fecha BETWEEN '$fechaInicial' AND '$fechaFinalMasUno' ORDER BY id DESC");

			}else{

				$link =Conexion::conectar();
				$stmt = $link->prepare("SELECT * FROM $tabla WHERE fecha BETWEEN '$fechaInicial' AND '$fechaFinal' ORDER BY id DESC");
	...
	static public function mdlSumaTotalVentas($tabla){	
		$link =Conexion::conectar();
		$stmt = $link->prepare("SELECT SUM(neto) as total FROM $tabla");
